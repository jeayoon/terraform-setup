...
class Config:
    ...
    # Set true to install apptainer (Updated MZJ Leo)
    enable_apptainer = False

    # Set true to install Conda(Pytorch, CUDA, Jupyternotebook) (Updated MZJ Leo)
    enable_conda = False

    # Set true to install Paramiko  (Updated MZJ Leo)
    enable_paramiko = False
